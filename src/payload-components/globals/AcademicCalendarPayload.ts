...
/**
 * 학사 일정(Academic Calendar) Global
 * 학기별 일정·주요 행사를 행정 관리자가 입력합니다.
 */
export const AcademicCalendarPayload: GlobalConfig = {
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              label: 'Time',
              admin: {
                description: '선택 사항. 예: 9:00 AM, 2:00–4:00 PM. 있으면 날짜 옆에 표시됩니다.',
              },
            },
          ],
        },
